...
#pragma warning restore 8500
                ...
                case DynamicValueType.NativeFunction:
                    return $"NativeFunction {a.NativeFunction!.Method.DeclaringType!.FullName}::{a.NativeFunction!.Method.Name}";
                case DynamicValueType.NativeObject:
                {
                    if (a.NativeObject == null)
                    {
                        return "NativeObject null";
                    }

                    var typeName = a.NativeObject.GetType().FullName;
                    return $"NativeObject {typeName} ({a.NativeObject})";
                }
                default:
                {
