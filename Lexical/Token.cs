    ...
    public class Token
    {
        ...
        public static string StringRepresentation(TokenType type)
        {
            switch (type)
            {
                ...
                case TokenType.CompoundModulo: return "%=";
                case TokenType.CompoundBitwiseAnd: return "&=";
                case TokenType.CompoundBitwiseOr: return "|=";
                case TokenType.CompoundBitwiseXor: return "^=";
